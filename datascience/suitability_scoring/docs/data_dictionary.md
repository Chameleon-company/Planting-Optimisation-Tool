...
*   **Missing values**: No missing values allowed. Whilst the suitability scoring handling missing data, it does so by normalising the score. This may result in a high score when values for an important feature is missing.
