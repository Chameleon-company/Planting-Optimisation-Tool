  ...
  return (
    <div>
      ...
      <p className="ahp-view-description">
        Process EPI data, Upload, Delete and View global weights for the MCDA engine. If no Global
        Weights are shown, equal global importance is applied to each feature. The
