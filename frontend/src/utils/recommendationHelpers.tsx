...
export const getEmptyStateStyle = (type: 'top' | 'caut' | 'exc'): React.CSSProperties => {
    ...
    switch (type) {
        case 'top':
            return { ...baseStyle, color: '#155724', backgroundColor: '#d4edda', borderColor: '#c3e6cb' };
        case 'caut':
            return { ...baseStyle, color: '#856404', backgroundColor: '#fff3cd', borderColor: '#ffeeba' };
        case 'exc':
            return { ...baseStyle, color: '#155724', backgroundColor: '#d4edda', borderColor: '#c3e6cb' };
        default:
            return baseStyle;
