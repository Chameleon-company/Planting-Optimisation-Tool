    ...
    <>
      ...
      <section className="admin-page-card">
        ...
        <div className="settings-grid">
          ...
          {/* Placeholder for Compatibility Matrix */}
          {/* Compatibility Matrix Card */}
          <NavLink to="/admin/settings/compatibility" className="settings-card">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <div className="settings-card-text">
              ...
              <p>Manage species compatibility with site conditions.</p>
            </div>
          </NavLink>
        </div>
      </section>
