            ...
            <section className="admin-page-content">
                ...
                <div className="settings-grid">
                    ...
                    <Link to="/admin/settings/weighting/hybrid" className="settings-card">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#ec4899" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="settings-card-icon" width="32" height="32">
