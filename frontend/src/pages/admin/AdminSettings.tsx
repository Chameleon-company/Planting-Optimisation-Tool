      ...
      <section className="admin-page-content">
        ...
        <div className="settings-grid">
          ...
          <Link to="/admin/settings/weighting" className="settings-card">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f59e0b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="settings-card-icon" width="32" height="32">
          ...
          <Link to="/admin/settings/scoring" className="settings-card">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="settings-card-icon" width="32" height="32">
          ...
          <Link to="/admin/settings/exclusions" className="settings-card">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="settings-card-icon" width="32" height="32">
          ...
          <Link to="/admin/settings/dependencies" className="settings-card">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="settings-card-icon" width="32" height="32">
