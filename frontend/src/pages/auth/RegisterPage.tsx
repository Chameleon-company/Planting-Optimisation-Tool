        ...
        <section className="login-card">
          ...
          <form className="login-form" onSubmit={handleSubmit} noValidate>
            <div className="login-form-group">
              ...
              />
              {nameError ? <p className="login-field-error">{nameError}</p> : null}
            </div>
            ...
            <div className="login-form-group">
              ...
              {confirmPasswordError ? <p className="login-field-error">{confirmPasswordError}</p> : null}
            </div>
            ...
            {errorMessage ? (
              <div className="login-message login-message-error">{errorMessage}</div>
            ) : (
              <div className="login-message login-message-placeholder">
                A verification email will be sent to your address after registration.
              </div>
            )}
